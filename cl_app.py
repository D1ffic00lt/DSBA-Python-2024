from services import get_shape, get_minimum_and_maximum, read_from_file, get_top_artists, Song
...
if __name__ == "__main__":
    ...
    parser.add_argument("-ta", "--top-artists", type=int, default=5,
                        help="Number of top artists to display (default: 5)")
    parser.add_argument("-m&m", "--min-max", type=int,
                        help="Display the minimum and maximum values in a specific column")
